...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/home-views/about-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/home-views/about-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript"
            src="<c:url value="/resources/style/home-views/about-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript"
            src="<c:url value="/resources/style/home-views/about-view/nicepage.js"/>" defer=""></script>
...
<section class="u-align-center u-black u-clearfix u-section-2" id="sec-3300">
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h2 class="u-text u-text-palette-2-dark-1 u-text-2">BE BETTER application</h2>
        <p class="u-align-left u-text u-text-3">
            <span style="font-weight: 700; font-size: 1.5rem;">Goal Tracking and Time Scales</span>
            <span style="font-size: 1.5rem;">: </span>Users can establish goals with varying time scales—daily, weekly, monthly, or yearly. This flexibility allows them to track short-term and long-term aspirations effectively.<br>
            <br>
            <span style="font-weight: 700; font-size: 1.5rem;">Points and Penalties System:</span>
            <span style="font-size: 1.5rem;"></span>Users can earn points for completing tasks or face penalties for task failures. This gamified approach encourages consistent goal completion and motivates users to stay on track.<br>
            <br>
            <span style="font-weight: 700; font-size: 1.5rem;">Frequent Tasks:</span>
            <br>
            <span style="font-weight: 700;">Definition:</span> Frequent tasks are routine activities that users need to perform regularly.<br>
            <span style="font-weight: 700;">Ease of Addition:</span> Users can quickly add these tasks to their schedule by clicking on them from a predefined list of "Frequent tasks."<br>
            <span style="font-weight: 700;">Customization: </span>Users have the option to customize the list of frequent tasks by using the "Configure frequent" button. This empowers users to tailor their goal tracking to their individual needs.<br>
            <br>
            <span style="font-size: 1.5rem; font-weight: 700;">Routine Tasks:</span>
            <br>
            <span style="font-weight: 700;">Definition: </span>Routine tasks encompass actions that must be completed daily, weekly, monthly, or yearly.<br>
            <span style="font-weight: 700;">Simplified Addition: </span>Users can easily add the entire list of routine tasks for a specific timeframe with a single click. This feature streamlines the process of adding habitual actions to the schedule.<br>
            <span style="font-weight: 700;">Examples:</span> Routine tasks could include simple habits like drinking water upon waking up or walking the dog.<br>
            <br>
            <span style="font-size: 1.5rem; font-weight: 700;">Comprehensive Platform:</span>
            <br>
            <span style="font-weight: 700;">Goal Management: </span>The website serves as a comprehensive platform for users to establish, manage, and track their goals.<br>
            <span style="font-weight: 700;">Efficiency and Routine:</span> The platform promotes efficiency and routine by assisting users in achieving both short-term and long-term aspirations.<br>
            <br>
            <span style="font-weight: 700; font-size: 1.5rem;">Developer's Skill Enhancement:</span>
            <br>
            <span style="font-weight: 700;">Background:&nbsp;</span>This website has been crafted with a dual purpose in mind. Beyond its goal-tracking capabilities, it also serves as a practical endeavor for the developer who created it.<br>
            <span style="font-weight: 700;">Skill Building:</span> The site has been developed as a means to hone and elevate skills in Java Spring—an essential technology in modern web development.<br>Continuous Learning: By creating this platform, the developer aims to continually refine their expertise while offering users a valuable tool for goal attainment.<br>
            <br>Overall, the website combines elements of gamification, user customization, and convenience to create a holistic goal-setting and tracking experience. It encourages users to cultivate positive habits, manage their time effectively, and make progress towards their personal objectives, while also serving as a testament to the developer's commitment to continuous improvement in web development.
        </p>
    </div>
</section>
