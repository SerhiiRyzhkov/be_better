...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/style/task-management-views/show-tasks-view/nicepage.css"/>" media="screen">
    <link rel="stylesheet" href="<c:url value="/resources/style/task-management-views/show-tasks-view/Main.css"/>" media="screen">
    <script class="u-script" type="text/javascript"
            src="<c:url value="/resources/style/task-management-views/show-tasks-view/jquery.js"/>" defer=""></script>
    <script class="u-script" type="text/javascript"
            src="<c:url value="/resources/style/task-management-views/show-tasks-view/jquery.js"/>" defer=""></script>
...
<section class="u-align-center u-black u-clearfix u-section-1" id="sec-89cd">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-layout-row">
                    ...
                    <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                        <div class="u-container-layout u-container-layout-2">
                            <a id="routineButton" class="u-border-2 u-border-active-palette-4-light-2 u-border-hover-black u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-50 u-text-hover-black u-btn-1"
                               style="cursor: pointer" onclick="window.location.href='/routine?type=DAILY'">CONFIGURE
                                ROUTINE</a>
                            <a id="frequentButton" class="u-border-2 u-border-active-palette-4-light-2 u-border-hover-black u-border-palette-4-base u-btn u-btn-round u-button-style u-hover-palette-4-base u-none u-radius-50 u-text-hover-black u-btn-2"
                               style="cursor: pointer" onclick="window.location.href='/frequent?type=DAILY'">configure
                                frequent</a>
                            <h2 class="u-text u-text-default u-text-palette-2-dark-1 u-text-1"><p id="shape-text" style="text-transform: uppercase">
                                ${scaleAtt}</p></h2>
                        </div>
                    </div>
        ...
        <div class="u-expanded-width u-list u-list-1">
            <div class="u-repeater u-repeater-1">
                ...
                <c:forEach items="${typesAtt}" var="t" >
                    ...
                    <c:if test="${t==typeAtt}" >
                        <div class="u-container-style u-list-item u-repeater-item" onclick="window.location.href='${frequencyAtt}?type=${t}'" style="cursor: pointer; ">
                            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-4">
                                <h3 class="u-align-center u-hover-feature u-text u-text-default u-text-palette-4-base u-text-5"><a style="color: yellow">${t}</a></h3>
                            </div>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${t!=typeAtt}">
                        <div class="u-container-style u-list-item u-repeater-item" onclick="window.location.href='${frequencyAtt}?type=${t}'" style="cursor: pointer; ">
                            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-4">
                                <h3 class="u-align-center u-hover-feature u-text u-text-default u-text-palette-4-base u-text-5"><a>${t}</a></h3>
                            </div>
                        </div>
                    </c:if>
                            ...
                            <div class="u-layout-row" id="scroll_${loop.index}">
                                ...
                                <div class="u-container-style u-layout-cell u-size-30-lg u-size-30-xl u-size-36-md u-size-36-sm u-size-36-xs u-layout-cell-5">
                                    <div class="u-container-layout u-container-layout-9">
                                        <a onclick="window.location.href='deleteTask?id=${t.id}'" class="u-align-left u-border-2 u-border-active-palette-4-light-2 u-border-hover-black u-border-palette-4-base u-btn u-btn-round u-button-style u-custom-item u-hover-palette-4-base u-none u-radius-50 u-text-hover-black u-btn-3">delete</a>
                                        <a onclick="window.location.href='updateTask?id=${t.id}'" class="u-align-left u-border-2 u-border-active-palette-4-light-2 u-border-hover-black u-border-palette-4-base u-btn u-btn-round u-button-style u-custom-item u-hover-palette-4-base u-none u-radius-50 u-text-hover-black u-btn-4">update</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <a onclick="window.location.href='addNewTask'" class="u-align-left u-border-2 u-border-active-palette-4-light-2 u-border-hover-black u-border-palette-4-base u-btn u-btn-round u-button-style u-custom-item u-hover-palette-4-base u-none u-radius-50 u-text-hover-black u-btn-7">add new task</a>
    </div>
...
<section class="skrollable skrollable-between u-align-center u-black u-clearfix u-section-3" src="" id="sec-c8b7">
    <div class="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        ...
        <img class="u-image u-image-circle u-image-1"
             ...
             data-image-width="1825" data-image-height="2738" data-animation-name="flipIn" data-animation-duration="1000" data-animation-direction="X">
    </div>
</section>
